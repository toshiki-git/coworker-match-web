 ...
 */
export function instanceOfCreateQuestionRes(value: object): value is CreateQuestionRes {
    ...
    if (!('matchingDate' in value) || value['matchingDate'] === undefined) return false;
    return true;
}
...
export function CreateQuestionResFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateQuestionRes {
    if (json == null) {
        return json;
    }
    return {
