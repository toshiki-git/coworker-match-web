 ...
 */
export function instanceOfCreateHobbyReq(value: object): value is CreateHobbyReq {
...
export function CreateHobbyReqFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateHobbyReq {
    if (json == null) {
        return json;
    }
    return {
