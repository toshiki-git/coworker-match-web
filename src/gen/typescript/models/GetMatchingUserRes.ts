 ...
 */
export function instanceOfGetMatchingUserRes(
  value: object
): value is GetMatchingUserRes {
...
export function GetMatchingUserResFromJSONTyped(
  json: any,
...
export function GetMatchingUserResToJSON(
  value?: GetMatchingUserRes | null
): any {
  if (value == null) {
    return value;
  }
