 ...
 */
export function instanceOfCreateHobbyRes(value: object): value is CreateHobbyRes {
...
export function CreateHobbyResFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateHobbyRes {
    if (json == null) {
        return json;
    }
    return {
